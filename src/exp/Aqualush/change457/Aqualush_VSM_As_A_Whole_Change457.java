 ...
 */
public class Aqualush_VSM_As_A_Whole_Change457 {
    public static void main(String[] args) {
        TextDataset textDataset4 = new TextDataset(AqualushSetting.Aqualush_Change4_As_A_Whole_Method,
        ...
        TextDataset textDataset5 = new TextDataset(AqualushSetting.Aqualush_Change5_As_A_Whole_Method,
        ...
        TextDataset textDataset7 = new TextDataset(AqualushSetting.Aqualush_Change7_As_A_Whole_Method,
