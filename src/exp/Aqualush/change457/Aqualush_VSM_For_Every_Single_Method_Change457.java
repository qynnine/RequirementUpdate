 ...
 */
public class Aqualush_VSM_For_Every_Single_Method_Change457 {
    public static void main(String[] args) {
        TextDataset textDataset4 = new TextDataset(AqualushSetting.Aqualush_Change4_For_Every_Single_Method,
        ...
        TextDataset textDataset5 = new TextDataset(AqualushSetting.Aqualush_Change5_For_Every_Single_Method,
        ...
        TextDataset textDataset7 = new TextDataset(AqualushSetting.Aqualush_Change7_For_Every_Single_Method,
