 ...
 */
public class Aqualush_VSM_For_Every_Single_Class_Change5 {
    public static void main(String[] args) {
        TextDataset textDataset = new TextDataset(AqualushSetting.Aqualush_Change5_For_Every_Single_Class,
