 ...
 */
public class Aqualush_VSM_For_Every_Single_Method_Change4 {
    public static void main(String[] args) {
        TextDataset textDataset = new TextDataset(AqualushSetting.Aqualush_Change4_For_Every_Single_Method,
