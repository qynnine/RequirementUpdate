...
/**
 * Created by niejia on 15/11/16.
 */
public class AqualushJSCompare4 {
    public static void main(String[] args) {
        ...
        Result result_ir_asOne = IR.compute(textDataset_AsOne, IRModelConst.JSD, new RegionBased_CSTI(), "Aqualush");
//        result_ir_asOne.showMatrix();
        ...
        Result result_ir_singleMethod = IR.compute(textDataset_singleMethod, IRModelConst.JSD, new RegionBased_CSTI(), "Aqualush");
//        result_ir_singleMethod.showMatrix();
        ...
        Result result_ir_singleClass = IR.compute(textDataset_singleClass, IRModelConst.JSD, new RegionBased_CSTI(), "Aqualush");
//        result_ir_singleClass.showMatrix();
        ...
        Result result_ir_method = IR.compute(textDataset_method, IRModelConst.JSD, new RegionBased_CSTI(), "Aqualush");
