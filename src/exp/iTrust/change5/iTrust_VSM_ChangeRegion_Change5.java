 ...
 */
public class iTrust_VSM_ChangeRegion_Change5 {
    public static void main(String[] args) {
        TextDataset textDataset = new TextDataset(ITrustSetting.iTrust_Change5_GroupedByMethod,
